...
class TestGoodsFunctions(unittest.TestCase):
    def setUp(self):
        self.goods = {"Radio": 200, "Headphones": 300, "Watch": 499.55555, "Ring": 749.47755}
    ...
    def test_get_good(self):
        ...
        self.assertEqual(result, ("Headphones", 300))  # checking that the correct good is returned

        with self.assertRaises(ValueError):
            result = ps.get_good(self.goods, "Laptop")  # trying to get the good that is absent in the dictionary
